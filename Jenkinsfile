//Global variables
            buildWithAnt{
              PROJECT_ID = "1540"			//The gitlab project ID. It can be found in the gitlab project interface.
              ...
              MODULE_FILENAME= "module.ivy"				// The module filename. Default value is : module.ivy. Set it if yours is different.
              LABEL = "public"					// The label where build must be run. Default value is : public. Set it if yours is different.
